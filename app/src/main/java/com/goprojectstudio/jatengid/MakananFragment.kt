 ...
 * Use the [MakananFragment.newInstance] factory method to
...
class MakananFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btn_makanan1 = view.findViewById<CardView>(R.id.btn_makanan1)
        btn_makanan1.setOnClickListener {
            val intent = Intent(activity, PembayaranActivity::class.java)
            startActivity(intent)
        }
//        val btn_makanan2 = view.findViewById<CardView>(R.id.btn_makanan2)
//        btn_makanan2.setOnClickListener{
